...
function CustomerSelector({customer, onSelect, onClear,  showError = false, }) {
    ...
    return (
        <>
            <div
                className={`rounded-xl border bg-white p-4 shadow-sm ${showError && !customer ? "border-red-400 ring-2 ring-red-100" : "border-slate-200"}`}
            >
                ...
                {customer ? (
                    <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-4">
                        ...
                        <div className="mt-3 flex items-center justify-between border-t border-emerald-100 pt-3">
                            ...
                            <span className={outstanding > 0 ? "text-sm font-semibold text-amber-600" : "text-sm font-semibold text-emerald-600"}>
                                Rs.{" "}
                    ...
                    <div className="relative">
                                    ...
                                    <div className="p-4">
                                        <div className="mb-3 text-center">
                                            ...
                                            <p className="mt-1 text-xs text-slate-400">
                                                Create a new customer to continue this sale.
                                            </p>
                                        </div>
                        ...
                        {!query.trim() && (
                            <button
                                ...
                                className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border border-dashed border-slate-300 py-3 text-sm font-semibold text-slate-600 hover:border-emerald-400 hover:bg-emerald-50 hover:text-emerald-700"
                            >
                                <UserPlus size={17} />
                                Create New Customer
                            </button>
