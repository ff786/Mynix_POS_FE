...
function CustomerLedger({
    ...
    const [updatingCheque, setUpdatingCheque] =
        useState(null);
    ...
    /*
     * CHEQUE_PAYMENT is represented by the
     * cheque row itself.
     */
    ...
    /*
     * Combine normal transactions and cheques.
     */
                ...
                <div className="border-b px-5 py-5">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <button
                            ...
                            className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-emerald-700 disabled:cursor-not-allowed disabled:bg-slate-200 disabled:text-slate-400"
                        >
                            <PlusCircle size={17} />
                            Record Payment
                        </button>
                                        ...
                                        <div className="flex items-center justify-between gap-4 sm:justify-end">
                                            ...
                                            {isCreditSale && (
                                                <button
                                                    ...
                                                    className="rounded-lg border border-emerald-200 bg-white px-3 py-2 text-xs font-semibold text-emerald-700 transition hover:bg-emerald-50 disabled:cursor-not-allowed disabled:opacity-40"
                                                >
                                                    Record Payment
                                                </button>
                                            )}
